...
//         // ✅ Retry MongoDB connection before running tests
//         let retries = 3;
...
//             this.skip(); // ✅ Skip tests if database is not connected
//         }

//         await Notification.deleteMany({}); // ✅ Clear notifications before tests
...
//         expect([200, 201]).to.include(res.status); // ✅ Allow both 200 & 201
//         expect(res.body).to.have.property('message', "Notification created successfully"); // ✅ Fix: Check message instead of `success`
//         expect(res.body).to.have.property('newNotification'); // ✅ Check if the `newNotification` field exists
//         expect(res.body.newNotification).to.have.property('message', notification.message); // ✅ Validate message
//     });
    
//     /** ✅ **TEST 3: Retrieve All Notifications** **/
//     it('should GET all notifications and return an array', async function () {
//         const res = await chai.request(server)
//             .get('/api/notifications/'); // ✅ Ensure this endpoint exists
