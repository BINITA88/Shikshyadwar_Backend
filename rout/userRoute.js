...
const { login, postEmailConfirmation,sendotp, signup, forgetPassword, resetPassword, userList, userDetails, signout, requireSignin, requireAdmin, deleteUser, uploadImage } = require('../controller/userController')
